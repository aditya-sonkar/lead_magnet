            ...
            {isOpen && (
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-[570px] sm:max-w-[595px] md:max-w-[610px] max-h-[94vh] sm:max-h-[90vh] min-h-0 sm:min-h-[535px] md:min-h-[555px] pb-3 sm:pb-8 md:pb-9 bg-[#F6F6F6] rounded-none pt-3.5 sm:pt-8 md:pt-9 px-3.5 sm:px-7 md:px-8 shadow-[0_20px_60px_rgba(0,0,0,0.3)] my-auto text-[#111827] z-10 flex flex-col justify-between overflow-y-auto overscroll-contain cursor-default select-text transition-[min-height,padding] duration-200"
                    ...
                    >
                        ...
                        <button
                            ...
                            className="absolute top-3.5 right-3.5 sm:top-7 sm:right-7 w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center text-[#333333] hover:text-black transition-colors cursor-pointer z-20"
                        >
