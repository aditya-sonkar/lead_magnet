                                ...
                                <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="font-satoshi w-full px-5 py-2.5 sm:py-3 rounded-full border border-[#D1D5DB] focus:outline-none focus:border-[#18181B] focus:ring-1 focus:ring-[#18181B] text-[clamp(12.5px,1vw,13.5px)] text-[#111827] bg-[#F1F1F3] placeholder-[#444444] transition-all duration-200"
                                        />
                                    </div>
